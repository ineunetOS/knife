...
/**
 * Basic <tt>templated</tt> support for {@link IdentifierGeneratorFactory}
 * implementations.
 * 
 * Note: used in hibernate.core.
 * 
...
public class DefaultIdentifierGeneratorFactory implements IdentifierGeneratorFactory, Serializable {
	private static final long serialVersionUID = -4299236270060781317L;
	...
	public DefaultIdentifierGeneratorFactory() {
		...
		register("hilo", SequenceStyleGenerator.class);
	...
	public IdentifierGenerator createIdentifierGenerator(String strategy, Type type, Properties config) {
		try {
			...
			String msg = "Could not instantiate id generator [entity-name=" + config.get(IdentifierGenerator.ENTITY_NAME) + "]";
	...
	public Class<?> getIdentifierGeneratorClass(String strategy) {
		if (Configs.isMySql()) {
			if ("seqhilo".equals(strategy) || "sequence".equals(strategy)) {
